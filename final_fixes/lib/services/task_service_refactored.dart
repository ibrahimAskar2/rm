...
class TaskServiceRefactored {
  ...
  // طريقة بديلة لإنشاء إشعار للمهمة
  Future<void> _createTaskNotification({
    ...
    try {
      // إنشاء إشعار باستخدام AppNotification
      final notification = AppNotification.createTaskNotification(
        userId: userId,
        senderId: senderId,
      ...
      print('Error creating task notification: $e');
    }
  }
}
